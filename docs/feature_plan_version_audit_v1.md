...
| Category | Current | Latest | Gap | Urgency |
|----------|---------|--------|-----|---------|
| **Swift: WhisperKit** | 0.13.1 | 0.15.0 | 2 minor versions | **HIGH** |
| **Swift: FluidAudio** | 0.1.0 | 0.10.0 | 9 minor versions | **CRITICAL** |
| **Python: MLX** | 0.27.1 | 0.30.3 | 3 minor versions | HIGH |
...
- **Complications:**
  - May affect multiple implementations (mlx-whisper, whisper-mps, lightning-whisper-mlx, parakeet-mlx)
  - Should be done atomically with mlx-metal
